...
void addSchedule()
{
    ...
    while (fscanf(fb, "%d %s %s %d %d %d %d %d", &term.day, &term.subject, &term.lecturer, &term.dat.date_DD, &term.dat.date_MM, &term.dat.date_YY, &term.tim.time_HH, &term.tim.time_MM) != EOF)
    {
        if ((term.dat.date_DD == schedule.dat.date_DD) && (term.dat.date_MM == schedule.dat.date_MM) && (term.dat.date_YY == schedule.dat.date_YY))
        {
    ...
    else
    {
        printf("End\n> Added Successfully!!\n");
        // input data in file
        fprintf(fb, "%d %s %s %d %d %d %d %d\n", schedule.day, schedule.subject, schedule.lecturer, schedule.dat.date_DD, schedule.dat.date_MM, schedule.dat.date_YY, schedule.tim.time_HH, schedule.tim.time_MM);
    }
...
void viewSchedules()
{
    ...
    while (fscanf(fb, "%d %s %s %d %d %d %d %d", &schedule.day, &schedule.subject, &schedule.lecturer, &schedule.dat.date_DD, &schedule.dat.date_MM, &schedule.dat.date_YY, &schedule.tim.time_HH, &schedule.tim.time_MM) != EOF)
    {
...
void deleteSchedule()
{
    ...
    while (fscanf(ft, "%d %s %s %d %d %d %d %d", &schedule.day, &schedule.subject, &schedule.lecturer, &schedule.dat.date_DD, &schedule.dat.date_MM, &schedule.dat.date_YY, &schedule.tim.time_HH, &schedule.tim.time_MM) != EOF)
    {
        fprintf(fb, "%d %s %s %d %d %d %d %d \n", schedule.day, &schedule.subject, &schedule.lecturer, schedule.dat.date_DD, schedule.dat.date_MM, schedule.dat.date_YY, schedule.tim.time_HH, schedule.tim.time_MM);
    }
